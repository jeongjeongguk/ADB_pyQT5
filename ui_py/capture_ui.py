...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0012.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0016.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox.addItem(icon6, "")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0015.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon7.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0013.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "새 캡처 "))
        self.label_4.setText(_translate("MainWindow", "저장"))
        self.label_5.setText(_translate("MainWindow", "복사"))
        self.label_6.setText(_translate("MainWindow", "공유"))
        self.label_7.setText(_translate("MainWindow", "지우개"))
