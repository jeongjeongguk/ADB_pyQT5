...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NewCapture.setMinimumSize(QtCore.QSize(51, 54))
        self.NewCapture.setMaximumSize(QtCore.QSize(51, 54))
        self.NewCapture.setMouseTracking(True)
        self.NewCapture.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.NewCapture.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon1 = QtGui.QIcon()
        ...
        self.NewCapture.setIconSize(QtCore.QSize(30, 30))
        ...
        self.Save.setMinimumSize(QtCore.QSize(51, 54))
        self.Save.setMaximumSize(QtCore.QSize(51, 54))
        self.Save.setMouseTracking(True)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0019.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0021.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.Copy.setMinimumSize(QtCore.QSize(51, 54))
        self.Copy.setMaximumSize(QtCore.QSize(51, 54))
        self.Copy.setMouseTracking(True)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0007.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Copy.setIcon(icon3)
        self.Copy.setIconSize(QtCore.QSize(30, 30))
        self.Copy.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.Copy.setAutoRaise(True)
        self.Copy.setObjectName("Copy")
        self.horizontalLayout.addWidget(self.Copy)
        self.Share = QtWidgets.QToolButton(self.centralwidget)
        self.Share.setMinimumSize(QtCore.QSize(51, 54))
        self.Share.setMaximumSize(QtCore.QSize(51, 54))
        self.Share.setMouseTracking(True)
        self.Share.setWhatsThis("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/button/icons/TeamUP_0000.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Share.setIcon(icon4)
        self.Share.setIconSize(QtCore.QSize(25, 25))
        self.Share.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.Share.setAutoRaise(True)
        self.Share.setObjectName("Share")
        self.horizontalLayout.addWidget(self.Share)
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.horizontalLayout.addWidget(self.line_2)
        self.Pen = QtWidgets.QToolButton(self.centralwidget)
        self.Pen.setMinimumSize(QtCore.QSize(51, 54))
        self.Pen.setMaximumSize(QtCore.QSize(51, 54))
        self.Pen.setMouseTracking(True)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0018.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Pen.setIcon(icon5)
        self.Pen.setIconSize(QtCore.QSize(32, 32))
        self.Pen.setCheckable(True)
        self.Pen.setChecked(True)
        self.Pen.setAutoExclusive(True)
        self.Pen.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.Pen.setAutoRaise(True)
        self.Pen.setArrowType(QtCore.Qt.NoArrow)
        self.Pen.setObjectName("Pen")
        self.horizontalLayout.addWidget(self.Pen)
        self.quadrangle = QtWidgets.QToolButton(self.centralwidget)
        self.quadrangle.setMinimumSize(QtCore.QSize(51, 54))
        self.quadrangle.setMaximumSize(QtCore.QSize(51, 54))
        self.quadrangle.setMouseTracking(True)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0015.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.quadrangle.setIcon(icon6)
        self.quadrangle.setIconSize(QtCore.QSize(32, 32))
        self.quadrangle.setCheckable(True)
        self.quadrangle.setAutoExclusive(True)
        self.quadrangle.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.quadrangle.setAutoRaise(True)
        self.quadrangle.setObjectName("quadrangle")
        self.horizontalLayout.addWidget(self.quadrangle)
        self.Eraser = QtWidgets.QToolButton(self.centralwidget)
        self.Eraser.setMinimumSize(QtCore.QSize(51, 54))
        self.Eraser.setMaximumSize(QtCore.QSize(51, 54))
        self.Eraser.setMouseTracking(True)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/button/icons/ALCapture_0012.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Eraser.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.Eraser.setAutoRaise(True)
        ...
        self.Color = QtWidgets.QToolButton(self.centralwidget)
        self.Color.setMinimumSize(QtCore.QSize(51, 54))
        self.Color.setMaximumSize(QtCore.QSize(51, 54))
        self.Color.setMouseTracking(True)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/button/icons/mspaint_0001.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Color.setIcon(icon8)
        self.Color.setIconSize(QtCore.QSize(32, 32))
        self.Color.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.Color.setAutoRaise(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Copy.setText(_translate("MainWindow", "복사"))
        self.Share.setText(_translate("MainWindow", "공유"))
        self.Pen.setText(_translate("MainWindow", "펜"))
        self.quadrangle.setText(_translate("MainWindow", "도형"))
        self.Eraser.setText(_translate("MainWindow", "지우개"))
        self.Color.setText(_translate("MainWindow", "잉크색"))
