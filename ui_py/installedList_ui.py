...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.MonkeyTest_2 = QtWidgets.QPushButton(self.layoutWidget)
        self.MonkeyTest_2.setObjectName("MonkeyTest_2")
        self.verticalLayout.addWidget(self.MonkeyTest_2)
        ...
        self.MonkeyTest_3 = QtWidgets.QPushButton(self.layoutWidget)
        self.MonkeyTest_3.setObjectName("MonkeyTest_3")
        self.verticalLayout.addWidget(self.MonkeyTest_3)
    ...
    def retranslateUi(self, Form):
        ...
        self.MonkeyTest_2.setText(_translate("Form", "앱 시작"))
        ...
        self.MonkeyTest_3.setText(_translate("Form", "개발자페이지"))
