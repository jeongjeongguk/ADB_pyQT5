...
"}")
        ...
        self.LWUSB = QtWidgets.QListWidget(self.usb)
        self.LWUSB.setObjectName("LWUSB")
        self.gridLayout_2.addWidget(self.LWUSB, 0, 0, 1, 1)
        ...
        self.LWWIFI = QtWidgets.QListWidget(self.wifi)
        self.LWWIFI.setObjectName("LWWIFI")
        self.gridLayout_3.addWidget(self.LWWIFI, 0, 0, 1, 1)
        ...
        self.LWALL = QtWidgets.QListWidget(self.all)
        self.LWALL.setObjectName("LWALL")
        self.gridLayout_4.addWidget(self.LWALL, 0, 0, 1, 1)
        ...
        self.control.setMinimumSize(QtCore.QSize(580, 513))
...
"}")
        ...
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.log)
